                ...
                <div class="row">
                 <form class="col s12">
                  ...
                  <div class="col s12 right-align m-t-sm">
                   <a href="{{ route('login') }}" class="waves-effect waves-grey btn-flat">Sign in</a>
                   <button type="submit" class="waves-effect waves-light btn teal">Sign Up</button>
                 </div>
               </form>
             </div>
           </div>
